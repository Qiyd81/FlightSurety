...
contract FlightSuretyData {
    ...
    mapping(address => uint256) authorizedAppContracts;
    ...
    */
    ...
    {
        require(authorizedAppContracts[msg.sender] == 1, "AppContract is not authorized");
        _;
    }
    ...
    {
        require(airlines[msg.sender].isRegistered == true, "Airline need to be isRegistered");
        _;
    }
    ...
    */    
    ...
    {
        authorizedAppContracts[_appContract] = 1;
    }
    ...
    */   
    ...
    function addFundsToAirline(address airline, uint256 value) 
            external requireIsOperational requireAppContractAuthorized requireisRegisteredAirline
    {
